...
<!-- v1.3 -->
  ...
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://mtcharte.net" class="icon-tree"> María Teresa Camacho Hull - Artist</a></h1>
    </li>
	...
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://mtcharte.net/" title="María Teresa Camacho Hull - Artist – María Teresa Camacho Hull - Artist">
				<img src="http://mtcharte.net/assets/img/" alt="María Teresa Camacho Hull - Artist – María Teresa Camacho Hull - Artist">
			</a>
